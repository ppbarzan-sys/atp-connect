...
export const experimentsEs: Experiment[] = 
[
  {
    "num": 1,
    "cardEmoji": "⚖️",
    ...
    "duration": "20 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes descubren que el equilibrio requiere momentos iguales a ambos lados del punto de apoyo, verificando W = mg y la ecuación de momentos M = F × d.",
      "instructions": [
      ...
      "expectedOutcome": "La masa antes y después están dentro de ±0.01 g, confirmando la conservación del momento. Los estudiantes registran distancias y masas con precisión."
    },
    "experiment": {
      "equipment": [
        {
          "emoji": "⚖️",
          "name": "Lever bar (balanza arm)"
        },
        {
          "emoji": "🔩",
        ...
        {
          "emoji": "🏋️",
          "name": "Cylindrical masas (10 g, 25 g, 50 g)"
        },
        {
          "emoji": "🪝",
          "name": "S-hooks"
    ...
    "observations": [
      "Registrar the weight calculated from each mass and compare with the spring-balance reading.",
      "Anotar whether the lever balances and at what positions.",
      "Observar how doubling la distancia halves the required force for equilibrium."
    ],
    ...
    "ai": {
      ...
      "hint": "Recuerda: equilibrium means the moments are equal, not the masses. M = F × d on both sides.",
  ...
  },
  {
    ...
    "duration": "20 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes aprenden cómo una palanca de segundo género proporciona ventaja mecánica al tener la carga entre el punto de apoyo y el esfuerzo.",
      "instructions": [
        "Colocar a known mass at a measured distance from the fulcrum on one side.",
        "Find the position or magnitude of a second force that restores equilibrium.",
        "Registrar all distances and forces, then calculate both moments."
      ],
      "expectedOutcome": "Los estudiantes demuestran que menos fuerza es necesaria para levantar la carga con una palanca de segundo género."
    },
    "experiment": {
      "equipment": [
        {
      ...
      "observationsToRecord": [
        "Fuerza F₁ (N) and arm length d₁ (m) for the first load",
        "Fuerza F₂ (N) and arm length d₂ (m) for the balancing load",
    ...
    "questions": {
      "mcq": [
        {
          "text": "A 65 g mass is placed 8 cm from the fulcrum. ¿Cuál es el/la moment it creates?",
          "options": [
            "0.052 N·m",
            "0.065 N·m",
            "0.080 N·m",
      ...
      "discussion": [
        ...
        "¿Cómo the principle of moments apply to the design of a wheelbarrow?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
      ...
      "hook": "¿Alguna vez has used a long spanner to undo a stuck bolt? You were using the principle of moments — a longer arm means a bigger turning effect with the same force!",
      "khanLinks": [
        {
          "title": "Introducción a Torque",
          "url": "https://www.khanacademy.org/science/physics/torque-angular-momentum/torque-tutorial/v/introduction-to-torque"
    ...
    "observations": [
      ...
      "Anotar any asymmetry in the lever bar itself and how this affects results.",
      "Observar how the same moment can be produced by different force-distance combinations."
    ],
    ...
    "ai": {
      "opening": "Exploremos moments and equilibrium! Ask me about calculating moments, lever classes, or the experiment setup.",
      "keywords": {
  ...
  },
  {
    ...
    "duration": "20 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes entienden que una palanca de tercer género sacrifica fuerza por velocidad, con el esfuerzo entre el punto de apoyo y la carga.",
      "instructions": [
        ...
        "Repetir with different loads to plot a deflection vs. mass graph."
      ],
      "expectedOutcome": "Los estudiantes observan que se necesita más fuerza pero se gana mayor velocidad y alcance del movimiento."
    },
    "experiment": {
      "equipment": [
        {
          "emoji": "⚖️",
          "name": "Beam balanza with pointer"
        },
        {
          "emoji": "🏋️",
        ...
        {
          "emoji": "🏋️",
          "name": "Test masas (10 g, 25 g, 50 g)"
        },
        {
          "emoji": "📐",
    ...
    "overview": {
      ...
      "misconceptions": [
        "Los estudiantes a menudo piensan a more sensitive balance is always better; in fact, high sensitivity limits the maximum measurable mass.",
    ...
    "observations": [
      "Observar how the pointer deflects more for larger added masses.",
      "Anotar whether the sensitivity (div per mg) remains constant or changes.",
      "Registrar the resting position each time a mass is removed to check for hysteresis."
    ],
  ...
  },
  {
    ...
    "duration": "30 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes verifican que la extensión del resorte es proporcional a la fuerza aplicada (dentro del límite elástico) y determinan la constante del resorte k.",
      "instructions": [
        "Colocar the fulcrum at one end of the lever bar.",
        ...
        "Calcular both moments and the reaction at the fulcrum."
      ],
      "expectedOutcome": "El gráfico de fuerza vs. extensión es una línea recta que pasa por el origen, con pendiente igual a k."
    },
    "experiment": {
      "equipment": [
        {
    ...
    "questions": {
      "mcq": [
        ...
        {
          "text": "A 65 g load at 8 cm from a fulcrum is balanced by an effort at 10 cm. ¿Cuál es el/la required effort?",
          "options": [
            "0.51 N",
            "0.64 N",
            "0.80 N",
        ...
        {
          "text": "¿Cuál es el/la mechanical advantage of a lever where the effort arm is twice the load arm?",
          "options": [
            "0.5",
            "1.0",
            "2.0",
      ...
      "discussion": [
        ...
        "¿Cómo the position of the load relative to the fulcrum affect the effort needed?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      ...
      "Anotar how the effort required is less than the load (MA > 1).",
      "Observar the reaction force direction at the end fulcrum."
    ],
  ...
  },
  {
    ...
    "duration": "20 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes analizan las fuerzas en un plano inclinado y entienden cómo el ángulo afecta la componente de la gravedad a lo largo de la pendiente.",
      "instructions": [
        "Read the Vernier calliper: main scale + Vernier scale × 0.05 mm.",
        "Medir the outer diameter d and height h of each cylinder at least twice.",
        "Calcular r = d/2, then V = πr²h for each material."
      ],
      "expectedOutcome": "Los estudiantes obtienen valores de fuerza gravitacional que coinciden con mg sen θ."
    },
    "experiment": {
      "equipment": [
        {
    ...
    "questions": {
      "mcq": [
        {
          "text": "A Vernier calliper shows a main-scale reading of 20.0 mm and the 7th Vernier division coincides. ¿Cuál es el/la reading?",
          "options": [
            "20.35 mm",
            "20.07 mm",
            "20.70 mm",
    ...
    "observations": [
      "Registrar each diameter and height measurement to 0.05 mm precision.",
      "Anotar any difference between two diameter readings for the same cylinder.",
  ...
  },
  {
    ...
    "duration": "40 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes miden y comparan los coeficientes de fricción estática y dinámica, verificando que μs > μk.",
      "instructions": [
        "Method 1: Medir mass m with balance and volume V from calliper, then ρ = m/V.",
      ...
      "expectedOutcome": "La fuerza estática máxima es mayor que la fuerza de fricción dinámica para el mismo bloque."
    },
    "experiment": {
      "equipment": [
        {
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo the density of sea water compare to fresh water, and what practical consequences does this have?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      "Registrar masses to ±0.01 g and volumes to ±0.1 cm³.",
      "Compare ρ from both methods and calculate percentage difference.",
      "Anotar which method is more accurate and explain why."
    ],
  ...
  },
  {
    ...
    "duration": "20 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes verifican que el período del péndulo depende solo de la longitud y de g, no de la masa.",
      "instructions": [
      ...
      "expectedOutcome": "El gráfico de T² vs. L es lineal, con pendiente que permite calcular g."
    },
    "experiment": {
      "equipment": [
        {
        ...
        {
          "emoji": "🔧",
          "name": "Three resorte dynamometers"
        },
        {
          "emoji": "📐",
          "name": "Transportador"
    ...
    "questions": {
      "mcq": [
        {
          "text": "Two forces of 40 g and 20 g act at 90° to each other. ¿Cuál es el/la approximate resultant?",
          "options": [
            "0.44 N",
            "0.60 N",
            "0.20 N",
    ...
    "observations": [
      "Registrar the angles of each dynamometer on the goniometric circle.",
      "Anotar any friction effects that prevent the ring from staying centered.",
  ...
  },
  {
    ...
    "duration": "20 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes miden cómo diferentes configuraciones de poleas multiplican la fuerza a costa de la distancia.",
      "instructions": [
      ...
      "expectedOutcome": "La ventaja mecánica medida coincide con el número de cuerdas que soportan la carga."
    },
    "experiment": {
      "equipment": [
        {
          "emoji": "🔵",
          "name": "Fixed polea on support"
        },
        {
          "emoji": "🪢",
          "name": "Inextensible cuerda"
        },
        {
          "emoji": "🏋️",
          "name": "Masas (50 g, 100 g)"
        },
        {
          "emoji": "🔧",
          "name": "Resorte dynamometer"
        }
      ],
      "observationsToRecord": [
    ...
    "questions": {
      "mcq": [
        {
          "text": "¿Cuál es el/la mechanical advantage of a single fixed pulley?",
          "options": [
            "0.5",
            "1",
            "2",
      ...
      "discussion": [
        ...
        "¿Cómo a fixed pulley differ from a movable pulley in terms of mechanical advantage?",
    ...
    "observations": [
      ...
      "Anotar any friction effects that make effort slightly greater than load.",
      "Observar that the pulley only changes force direction."
    ],
  ...
  },
  {
    ...
    "duration": "20 min",
    "summary": {
      "whatTheyLearn": "Los estudiantes encuentran el centro de gravedad de objetos irregulares y entienden el concepto de equilibrio.",
      "instructions": [
        "Preparar the movable pulley with both string segments supporting the load.",
      ...
      "expectedOutcome": "El centro de gravedad encontrado por diferentes métodos coincide para el mismo objeto."
    },
    "experiment": {
      "equipment": [
        {
        ...
        {
          "emoji": "🏋️",
          "name": "Masas (50 g, 100 g, 150 g, 200 g)"
        },
        {
          "emoji": "🔧",
          "name": "Resorte dynamometer"
    ...
    "questions": {
      "mcq": [
        {
          "text": "A movable pulley supports a 200 g load. ¿Cuál es el/la ideal effort required?",
          "options": [
            "0.49 N",
            "0.98 N",
            "1.96 N",
      ...
      "discussion": [
        ...
        "¿Cómo friction affect the mechanical advantage of a real pulley system?",
    ...
    "observations": [
      "Registrar P and R for each load and calculate MA.",
      "Compare actual MA with ideal value of 2.",
      "Medir how far the effort string moves for a fixed load displacement."
    ],
  ...
  },
  {
    ...
    "experiment": {
      ...
      "observationsToRecord": [
        ...
        "Distancia effort rope moves vs. distance load rises"
      ],
      "theoryPoints": [
    ...
    "questions": {
      "mcq": [
        ...
        {
          "text": "¿Cuál es el/la main advantage of adding a fixed pulley to the system?",
          "options": [
            "It doubles the MA",
            "It halves the load",
    ...
    "overview": {
      ...
      "khanLinks": [
        {
          "title": "Introducción a Work & Energy",
          "url": "https://www.khanacademy.org/science/physics/work-and-energy/work-and-energy-tutorial/v/introduction-to-work-and-energy"
        },
        {
          "title": "AP Physics 1: Work & Energy",
    ...
    "observations": [
      ...
      "Medir s_effort and s_load and confirm the 2:1 ratio.",
      "Anotar the direction of the effort force (downward) compared to the load (upward)."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Registrar the force F for masses of 50 g, 100 g, and 150 g."
      ],
    ...
    "experiment": {
      ...
      "observationsToRecord": [
        ...
        "Fuerza F (N) to pull mass up the slope"
      ],
      "theoryPoints": [
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "A ramp is 3 m long and rises 1 m. ¿Qué es its MA? What effort is needed to push a 60 kg box up it?",
        "¿Cómo friction affect the mechanical advantage of a real inclined plane?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
      ...
      "misconceptions": [
        "Los estudiantes a menudo piensan friction decreases on steeper slopes; in fact the normal force (and friction) decreases but the required force still increases.",
    ...
    "observations": [
      "Registrar the force needed to pull each mass up the slope at constant speed.",
  ...
  },
  {
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🌀",
          "name": "Helical resorte"
        },
        {
          "emoji": "📏",
          "name": "Regla or metre stick"
        },
        {
          "emoji": "🏋️",
          "name": "Masas (10 g, 25 g, 50 g)"
        },
        {
          "emoji": "🪝",
          "name": "Mass hanger"
    ...
    "observations": [
      "Registrar natural length L₀ carefully with no mass attached.",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Conectar two springs in series: measure extension for each load; calculate 1/k_s.",
        "Conectar the same springs in parallel: measure extension for same loads; calculate k_p.",
        "Preparar the paradox: two springs compressed against a mass; cut the middle string."
      ],
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🌀",
          "name": "Two identical helical resortes"
        },
        {
          "emoji": "📏",
          "name": "Regla"
    ...
    "questions": {
      "mcq": [
        {
          "text": "Two springs each with k = 10 N/m are connected in series. ¿Cuál es el/la combined spring constant?",
          "options": [
            "20 N/m",
            "10 N/m",
            "5 N/m",
      ...
      "discussion": [
        ...
        "A mattress has 100 parallel springs each with k = 200 N/m. ¿Qué es the total k?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      "Registrar extension for series and parallel for the same loads.",
      "Confirm that series extends more than a single spring and parallel extends less.",
      "Observar the direction of motion when the paradox string is cut."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Repetir for L = 1.0 m. Calcular T and compare with T = 2π√(L/g)."
      ],
    ...
    "experiment": {
      "equipment": [
        ...
        {
          "emoji": "🧵",
          "name": "Inextensible cuerda (adjustable 0.25–1.0 m)"
        },
        {
          "emoji": "⏱️",
          "name": "Cronómetro"
      ...
      "observationsToRecord": [
        "Longitud L (m) from pivot to centre of bob",
        "Tiempo for 50 oscillations t₅₀ (s)",
        "Period T = t₅₀/50 (s)",
        "T² (s²)"
      ],
      "theoryPoints": [
    ...
    "overview": {
      ...
      "misconceptions": [
        "Los estudiantes a menudo piensan heavier bobs swing faster; period is independent of mass.",
    ...
    "observations": [
      ...
      "Registrar t₅₀ three times and average to reduce timing error.",
  ...
  },
  {
    ...
    "experiment": {
      ...
      "observationsToRecord": [
        "Mass m (kg)",
        "Tiempo for 20 oscillations t₂₀ (s)",
        "Period T = t₂₀/20 (s)",
    ...
    "observations": [
      "Displace la masa no more than 5 cm to stay within SHM approximation.",
      "Time 20 oscillations three times and average.",
      "Registrar L = 0.25 m → 20.20 s and L = 1.0 m → 40.40 s from curriculum."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Conectar several tubes of different shapes and diameters at the base.",
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo a hydraulic jack use the communicating vessels principle to multiply force?",
    ...
    "overview": {
      ...
      "misconceptions": [
        "Los estudiantes a menudo piensan the narrower tube will have a higher level; shape is irrelevant.",
    ...
    "observations": [
      "Registrar the level in each tube and confirm they are equal.",
      "Observar the effect of pressing one tube on all others.",
      "Anotar that level is independent of tube diameter."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Pesar the object in air: W_air (N).",
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "⚖️",
          "name": "Resorte balanza or force sensor"
        },
        {
          "emoji": "🫙",
          "name": "Displacement vessel (Eureka can)"
    ...
    "questions": {
      "mcq": [
        {
          "text": "A 50 g mass displaces 5.5 mL of water. ¿Cuál es el/la buoyant force?",
          "options": [
            "0.054 N",
            "0.49 N",
            "0.54 N",
        ...
        {
          "text": "An object weighs 2.0 N in air and 1.4 N when submerged. ¿Cuál es el/la buoyant force?",
          "options": [
            "3.4 N",
            "0.6 N",
            "1.4 N",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Medir T_cold (cold water) and T_hot (hot water) with a thermometer.",
    ...
    "experiment": {
      "equipment": [
        ...
        {
          "emoji": "💧",
          "name": "Hot agua (~70°C) and cold agua (~20°C)"
        },
        {
          "emoji": "⏱️",
          "name": "Cronómetro"
        ...
        {
          "emoji": "⚖️",
          "name": "Balanza (to measure equal masas)"
        }
      ],
      "observationsToRecord": [
        "T_cold (°C) antes mixing",
        "T_hot (°C) antes mixing",
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Qué es the purpose of stirring the mixture during the experiment?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      "Registrar T every 30 seconds after mixing until it stabilises.",
      "Anotar the final equilibrium temperature and compare with the predicted value.",
      "Describe the shape of la temperatura-time graph."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Registrar temperature every 30 s for 4 minutes in each container."
      ],
    ...
    "experiment": {
      ...
      "observationsToRecord": [
        ...
        "Temperatura at 30 s intervals for 240 s",
        "Temperatura difference después 240 s for each configuration"
      ],
      "theoryPoints": [
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo a thermos flask differ from ordinary insulation? Why is it more effective?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      "Registrar temperature every 30 s for all three cups simultaneously.",
  ...
  },
  {
    ...
    "observations": [
      ...
      "Registrar steel T_eq ≈ 39°C, copper T_eq ≈ 37°C."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Colocar left hand in cold bowl and right hand in hot bowl for 1 minute.",
    ...
    "experiment": {
      "equipment": [
        ...
        {
          "emoji": "🧊",
          "name": "Cold agua (~10°C) and hot agua (~50°C)"
        },
        {
          "emoji": "💧",
          "name": "Warm agua (~35°C)"
      ...
      "observationsToRecord": [
        ...
        "Temperatura of middle bowl confirmed by thermometer"
      ],
      "theoryPoints": [
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo this experiment support the need for thermometers in science?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      ...
      "Confirm la temperatura of the middle bowl with a thermometer.",
      "Anotar how long the perceptual difference persists."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Observar the liquid bubbling and moving to the other (cooler) bulb.",
        "Registrar the observations and explain using vapour pressure concepts."
      ],
    ...
    "experiment": {
      "equipment": [
        ...
        {
          "emoji": "🌡️",
          "name": "Termómetro (optional, to confirm room temperature)"
        }
      ],
      "observationsToRecord": [
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo a pressure cooker use the opposite principle to the pulse glass?",
    ...
    "observations": [
      ...
      "Anotar the direction of liquid/bubble movement.",
      "Observar what happens when you let go."
    ],
    "conclusion": "The pulse glass demonstrates that boiling point decreases with pressure. The near-vacuum inside allows room-temperature warming (~5°C above ambient) to initiate boiling. Esto confirma the vapour pressure-boiling point relationship.",
    "ai": {
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Registrar the thermometer reading in air (T₀ ≈ 25°C).",
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🌡️",
          "name": "Mercury or alcohol termómetro"
        },
        {
          "emoji": "☕",
          "name": "Vaso de precipitados of hot agua (~60°C)"
        },
        {
          "emoji": "⏱️",
          "name": "Cronómetro"
      ...
      "observationsToRecord": [
        ...
        "Temperatura T at t = 0, 5, 8, 10 s después plunging",
    ...
    "observations": [
      "Registrar T at t = 0, 5, 8, 10 s after plunging.",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Conectar one arm to a gas source (lungs, pump, or sealed flask).",
    ...
    "questions": {
      "mcq": [
        {
          "text": "A U-tube manometer shows Δh = 10 cm of water. ¿Cuál es el/la gauge pressure?",
          "options": [
            "98 Pa",
            "980 Pa",
            "9800 Pa",
      ...
      "discussion": [
        ...
        "¿Cómo the density of the manometer liquid affect the sensitivity of the reading?",
    ...
    "observations": [
      "Anotar the direction liquid moves when pressure is applied vs. released.",
      "Medir Δh accurately with ruler.",
      "Observar how different breath pressures give different Δh values."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Registrar the resonance length L_res and calculate λ = 4L_res, then v = fλ."
      ],
    ...
    "observations": [
      "Registrar the tube length at maximum loudness (resonance).",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Colocar two identical 440 Hz tuning forks on resonance boxes facing each other.",
        "Strike fork A and then immediately damp it; observe if fork B vibrates.",
        "Repetir with a different-frequency fork B — observe no resonance."
      ],
    ...
    "experiment": {
      ...
      "observationsToRecord": [
        "Whether fork B vibrates después A is struck and damped",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Calcular f_beat = beats / 10 s and compare with |440 − 437| = 3 Hz."
      ],
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🎵",
          "name": "Diapasón 440 Hz"
        },
        {
          "emoji": "🎵",
          "name": "Diapasón 437 Hz (or 440 Hz with wax added)"
        },
        {
          "emoji": "⏱️",
          "name": "Cronómetro"
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Registrar f for three different lenses of each type."
      ],
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🔵",
          "name": "Set of biconvex lentees (3 different)"
        },
        {
          "emoji": "🔵",
          "name": "Set of biconcave lentees (3 different)"
        },
        {
          "emoji": "🔦",
      ...
      "observationsToRecord": [
        ...
        "Distancia from lens to sharp image f (m)",
    ...
    "observations": [
      "Registrar focal length for each of the 3 biconvex and 3 biconcave lenses.",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Colocar object at p = 200 mm from a lens of known f.",
        "Move the screen until a sharp image forms; record q.",
        "Repetir for p = 150, 130, 100 mm and verify 1/p + 1/q = 1/f each time."
      ],
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo a projector differ from a camera in terms of where the object is placed relative to f?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      "Registrar p and q for each trial.",
      "Calculate 1/p + 1/q and compare with 1/f.",
      "Anotar whether image is real (q>0) or virtual (q<0)."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Preparar object (arrow slide) at measured distance u from lens.",
        "Find sharp image on screen at distance v.",
        "Medir S₁ (object size) and S₂ (image size); calculate m = S₂/S₁ and compare with −v/u."
      ],
    ...
    "questions": {
      "mcq": [
        {
          "text": "Object at u = 35 mm, image at v = 86.5 mm. ¿Cuál es el/la magnification?",
          "options": [
            "−2.47",
            "+2.47",
            "−0.40",
    ...
    "observations": [
      "Medir S₁ of the object with a ruler before the experiment.",
      "Medir S₂ of the image on the screen carefully.",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Registrar the colour at each overlap region.",
        "Repetir with coloured filters (subtractive): observe different results."
      ],
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo a TV screen produce millions of colours using only three colours?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      "Registrar the colour at each overlap zone on the white screen.",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Medir total magnification by comparing image and object apparent sizes."
      ],
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🔵",
          "name": "Short focal length lente (objective)"
        },
        {
          "emoji": "🔵",
          "name": "Medium focal length lente (eyepiece)"
        },
        {
          "emoji": "📏",
          "name": "Optical bench"
        ...
        {
          "emoji": "🔭",
          "name": "Long focal length lente (telescope objective)"
        }
      ],
      "observationsToRecord": [
    ...
    "observations": [
      "Registrar lens focal lengths and measure magnification for the microscope setup.",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Observar the spectrum on a screen and identify the colours in order.",
    ...
    "experiment": {
      "equipment": [
        ...
        {
          "emoji": "📏",
          "name": "Regla (to measure deviation angles)"
        }
      ],
      "observationsToRecord": [
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Qué es chromatic aberration and how does it relate to dispersion?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "conclusion": "White light dispersed into ROY G BIV spectrum. Violet deviated most, red least. Esto confirma n(violet) > n(red) in glass and Snell's law with wavelength-dependent refractive index. Replicates Newton's 1666 experiment.",
    "ai": {
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Colocar a small opaque object between a point light source and a screen.",
        "Medir the shadow size vs. object-screen distance.",
        "Repetir with an extended (larger) light source and observe the penumbra."
      ],
    ...
    "questions": {
      "mcq": [
        {
          "text": "¿Cuál es el/la key difference between umbra and penumbra?",
          "options": [
    ...
    "observations": [
      "Registrar shadow dimensions for both point and extended sources.",
      "Observar and sketch the umbra and penumbra regions.",
      "Anotar how shadow size changes when object-screen distance changes."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Colocar object beyond C (centre of curvature) of concave mirror; locate real image.",
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Qué es the significance of the warning 'Objects in mirror are closer than they appear' on car mirrors?"
      ]
    },
    "overview": {
      "conceptBreakdown": [
    ...
    "observations": [
      ...
      "Medir and compare f using 1/v + 1/u = 1/f."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        ...
        "Medir force (qualitatively) at several distances."
      ],
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🧲",
          "name": "Two bar imáns (labelled N/S)"
        },
        {
          "emoji": "📏",
          "name": "Regla"
        ...
        {
          "emoji": "🧭",
          "name": "Brújula (to identify poles)"
        }
      ],
      "observationsToRecord": [
        "Fuerza type (attract/repel) for each pole combination",
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo a compass work? Which end of a compass points north, and why is this nomenclature confusing?",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Colocar the U-shaped magnet under the 2D field chamber.",
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo the spacing of field lines indicate the strength of the field?",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Colocar compass in different positions around a bar magnet.",
        "Registrar the direction the compass needle points at each location.",
    ...
    "experiment": {
      "equipment": [
        ...
        {
          "emoji": "📝",
          "name": "Paper (to place brújula on and mark directions)"
        },
        {
          "emoji": "✏️",
          "name": "Pencil"
    ...
    "observations": [
      ...
      "Anotar that compass N pole always points from N to S along the field."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Colocar two magnets N-N facing: observe repulsion.",
        "Colocar steel ball bearing between them: observe the magnets now move toward the ball.",
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🧲",
          "name": "Two identical small imáns (both N facing outward)"
        },
        {
          "emoji": "⚙️",
      ...
      "observationsToRecord": [
        "Fuerza type (attract/repel) without ball between N-N magnets",
        "Fuerza type with steel ball between N-N magnets",
    ...
    "questions": {
      ...
      "discussion": [
        ...
        "¿Cómo an electromagnet pick up iron objects? ¿Qué es the similarity to this experiment?",
    ...
    "observations": [
      "Registrar force type for: N-N (no ball), N-ball-N, after ball removed.",
      "Anotar the direction magnets move toward the ball.",
      "Observar whether ball retains magnetism after removal."
    ],
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Conectar resistor R₁ ≈ 100 Ω in series with ammeter; voltmeter across R₁.",
    ...
    "experiment": {
      "equipment": [
        ...
        {
          "emoji": "🪛",
          "name": "Connecting alambres and breadboard"
        }
      ],
      "observationsToRecord": [
        "Voltaje V (V) for each supply setting",
        "Corriente I (mA) for each V",
    ...
    "observations": [
      "Registrar V and I for at least 5 different supply voltages.",
  ...
  },
  {
    ...
    "summary": {
      ...
      "instructions": [
        "Medir R₁ and R₂ individually with ohmmeter or V/I method.",
        "Conectar in series; measure total R_T and verify R_T = R₁ + R₂.",
        "Conectar in parallel; measure R_T and verify 1/R_T = 1/R₁ + 1/R₂."
      ],
    ...
    "experiment": {
      "equipment": [
        {
          "emoji": "🔋",
          "name": "Batería or DC supply (5.8 V)"
        },
        {
          "emoji": "⚡",
        ...
        {
          "emoji": "🔌",
          "name": "Amperímetro and voltímetro"
        },
        {
          "emoji": "🪛",
          "name": "Connecting alambres, breadboard"
        }
      ],
      "observationsToRecord": [
    ...
    "observations": [
      "Registrar V and I for individual R₁, R₂, then series and parallel combinations.",
